...
namespace ARSoft.Tools.Net.Net
{
    ...
    public class DaneStream : AuthenticatedStream
    {
        ...
        /// </param>
        public void AuthenticateAsClient(string targetHost, int port, ProtocolType protocol = ProtocolType.Tcp, X509CertificateCollection clientCertificates = null, SslProtocols enabledSslProtocols = SslProtocols.Tls12, bool checkCertificateRevocation = false)
        {
