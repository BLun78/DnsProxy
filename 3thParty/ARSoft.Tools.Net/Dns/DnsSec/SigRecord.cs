...
namespace ARSoft.Tools.Net.Dns
{
    ...
    public class SigRecord : DnsRecordBase
    {
        ...
        internal override void ParseRecordData(DomainName origin, string[] stringRepresentation)
        {
            ...
            Algorithm = (DnsSecAlgorithm)Byte.Parse(stringRepresentation[1], CultureInfo.InvariantCulture);
            Labels = Byte.Parse(stringRepresentation[2], CultureInfo.InvariantCulture);
            OriginalTimeToLive = Int32.Parse(stringRepresentation[3], CultureInfo.InvariantCulture);
            ...
            KeyTag = UInt16.Parse(stringRepresentation[6], CultureInfo.InvariantCulture);
